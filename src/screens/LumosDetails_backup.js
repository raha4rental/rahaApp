...
const whatsappNumber = '12163144144';
    ...
    <ScrollView style={styles.container}>
      ...
      <View style={styles.locationSection}>
        ...
        <View style={styles.locationCard}>
          ...
          <View style={styles.locationFeature}>
            <MaterialIcons name="restaurant" size={24} color="#B8956D" />
            <View style={styles.locationTextContainer}>
          ...
          <View style={styles.locationFeature}>
            <MaterialIcons name="store" size={24} color="#B8956D" />
            <View style={styles.locationTextContainer}>
          ...
          <View style={styles.locationFeature}>
            <MaterialIcons name="local-hospital" size={24} color="#B8956D" />
            <View style={styles.locationTextContainer}>
          ...
          <View style={styles.locationFeature}>
            <MaterialIcons name="medical-services" size={24} color="#B8956D" />
            <View style={styles.locationTextContainer}>
      ...
      <View style={styles.facilitiesSection}>
        ...
        <View style={styles.facilitiesGrid}>
          <View style={[styles.facilityCard, { backgroundColor: '#fff5f5' }]}>
            ...
            >
              <MaterialIcons name="groups" size={24} color="#d32f2f" />
            </View>
          ...
          <View style={[styles.facilityCard, { backgroundColor: '#fdf2f8' }]}>
            ...
            >
              <MaterialIcons name="group" size={24} color="#ec407a" />
            </View>
          ...
          <View style={[styles.facilityCard, { backgroundColor: '#f0f9ff' }]}>
            ...
            >
              <MaterialIcons name="pool" size={24} color="#1976d2" />
            </View>
          ...
          <View style={[styles.facilityCard, { backgroundColor: '#fefce8' }]}>
            ...
            >
              <MaterialIcons name="celebration" size={24} color="#f57c00" />
            </View>
          ...
          <View style={[styles.facilityCard, { backgroundColor: '#f0fdf4' }]}>
            ...
            >
              <MaterialIcons name="fitness-center" size={24} color="#388e3c" />
            </View>
          ...
          <View style={[styles.facilityCard, { backgroundColor: '#f8fafc' }]}>
            ...
            >
              <MaterialIcons name="wifi" size={24} color="#546e7a" />
            </View>
            ...
            <View style={styles.infoGrid}>
              <View style={styles.infoRow}>
                <View style={styles.infoItem}>
                  <MaterialIcons name="square-foot" size={20} color="#B8956D" />
                  <Text style={styles.infoText}>{apartment.rooms}</Text>
                </View>
              </View>
              <View style={styles.infoRow}>
                <View style={styles.infoItem}>
                  <MaterialIcons name="business" size={20} color="#B8956D" />
                  <Text style={styles.infoText}>{apartment.floor}</Text>
                </View>
              </View>
              <View style={styles.infoRow}>
                <View style={styles.infoItem}>
                  <MaterialIcons name="visibility" size={20} color="#B8956D" />
          ...
          <View style={styles.modalContainer}>
            ...
            >
              ...
              <View style={styles.modalHeader}>
                ...
                >
                  <MaterialIcons name="close" size={24} color="#B8956D" />
                </TouchableOpacity>
              ...
              {selectedApartment && (
                <View style={styles.selectedApartmentInfo}>
                  ...
                  <View style={styles.apartmentInfoRow}>
                    <MaterialIcons name="home" size={20} color="#B8956D" />
